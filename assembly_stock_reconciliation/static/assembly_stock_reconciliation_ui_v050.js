        ...
        : h("div", { style: { overflowX: "auto" } },
            h("table", { style: styles.table },
              h("thead", null, h("tr", null,
                ...
                h("th", { style: styles.th }, "Stock Items"),
                h("th", { style: styles.th }, "Current Stock Item"),
                  ...
                  h("tr", { key: `part-allocation-${row.build}` },
                    ...
                    h("td", { style: styles.td },
                      (row.stock_items || []).map((si) =>
                        `#${si.stock_item}=${fmt(si.allocated)}${si.current_stock_item ? " (current)" : ""}`
                      ).join(", ") || "—",
                      row.multiple_stock_items
                        ? h("div", { style: { marginTop: "4px", fontWeight: 600, color: "#f08c00" } },
                            "⚠ Multiple Stock Items of this Part are allocated to this BO"
                          )
                        : null
                    ),
                    h("td", { style: styles.td }, row.uses_current_stock_item ? `Yes (${fmt(row.current_stock_item_allocated)})` : "No"),
