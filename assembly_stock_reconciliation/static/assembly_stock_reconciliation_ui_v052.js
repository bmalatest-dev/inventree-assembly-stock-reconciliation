    ...
    itemPreview ? h("div", { style: styles.card },
      ...
      hardWarning && !blocking
        ? h("div", { style: { ...styles.alertWarn, marginTop: "14px" } },
            ...
            h("p", null,
              "This reconciliation falls outside the normal policy range. If the physical return is higher than expected, an approved override will still record the selected BO nominal consumption and separately add back the inventory discrepancy so the final Stock Item quantity matches the physical count. Do not override until the discrepancy has been investigated."
            ),
